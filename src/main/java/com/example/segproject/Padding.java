...
public class Padding {
	...
	public static Integer[][][] addPadding(Integer[][][] tileMap3D) {
		tileMap3D = Padding.addLstartPadding(tileMap3D, 4);
		tileMap3D = Padding.addLendPadding(tileMap3D, 4);
		tileMap3D = Padding.addWleftPadding(tileMap3D, 4);
		tileMap3D = Padding.addWrightPadding(tileMap3D, 4);
		return (tileMap3D);
	}
}
