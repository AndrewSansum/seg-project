...
```
cd existing_repo
git remote add origin https://gitlab.com/cvGuillaume/seg-project.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/cvGuillaume/seg-project/-/settings/integrations)
